<template>
  <nav :class="['flex items-center gap-3 sm:gap-6', className]">
    <NuxtLink
    ...
    <div class="h-6 w-px bg-slate-300 hidden sm:block" aria-hidden="true"></div>
    <a
    ...
    <a
      href="https://twitter.com/fundamentalsSWE"
      target="_blank"
      rel="noopener noreferrer"
      class="text-slate-700 hover:text-slate-900 transition-colors"
